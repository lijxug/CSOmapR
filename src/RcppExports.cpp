...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< NumericVector >::type perplexity_list(perplexity_listSEXP);
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_CSOmapR_Rtsne_cpp", (DL_FUNC) &_CSOmapR_Rtsne_cpp, 34},
    {NULL, NULL, 0}
};
