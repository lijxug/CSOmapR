...
tic()
TPM_tbl <- read_tsv("/home/jason/git/CSOmapR/data-raw/demo/TPM.txt")
TPM_tbl = TPM_tbl[, -ncol(TPM_tbl)]
LR <- read.table("/home/jason/git/CSOmapR/data-raw/demo/LR_pairs.txt", header = FALSE, sep = "\t")
labelData <- read_tsv("/home/jason/git/CSOmapR/data-raw/demo/label.txt")
toc()

# set variables & validation ----
TPM = as.matrix(TPM_tbl[,-1])
rownames(TPM) = TPM_tbl[, 1, drop = T] 
assert_that(sum(is.na(TPM)) == 0)
